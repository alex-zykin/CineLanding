...
Вместе с переносимым ядром в репозитории теперь есть browser-local демо-кабинет на нативном Next.js для Vercel. В нём можно пройти путь от проекта и концепта до согласования, демо-сборки и превью без настоящих аккаунтов и backend. Авторизация, серверное хранение, оплата, задачи KIE и публикация создаваемых сайтов пока не подключены. Целевая архитектура описана в [`docs/saas-mvp.md`](docs/saas-mvp.md). Домен проекта: [cinelanding.ru](https://cinelanding.ru).
